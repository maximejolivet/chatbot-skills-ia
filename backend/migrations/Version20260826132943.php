 ...
 */
final class Version20260826132943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ai_agent_workflow (ai_agent_id INT NOT NULL, workflow_id INT NOT NULL, INDEX IDX_812831432BF2F76B (ai_agent_id), INDEX IDX_812831432C7C2CBA (workflow_id), PRIMARY KEY (ai_agent_id, workflow_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE document_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_898DE8985E237E06 (name), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
