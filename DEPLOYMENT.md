...
`/home/{{user}}/repositories/chatbot-skills-ia`) — seul le `public/` qu'il
contient doit être exposé en HTTP (rsync ne copie que le contenu de
`backend/`, donc `$DEPLOY_PROJECT_PATH` correspond à `backend/`, pas à la
racine du dépôt). Pointer le document root du sous-domaine
`chatbot.jolivetmaxime.fr` (cPanel > Domaines) vers
...
| `DEPLOY_PROJECT_PATH`    | `/home/{{user}}/repositories/chatbot-skills-ia`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
gh secret set DEPLOY_PROJECT_PATH -b"/home/{{user}}/repositories/chatbot-skills-ia"
