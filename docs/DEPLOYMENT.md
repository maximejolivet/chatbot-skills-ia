...
> `/home/{{user}}/repositories/symfony-ia-rag-chatbot/backend`) — seul
...
| `DEPLOY_PROJECT_PATH`    | `/home/{{user}}/repositories/symfony-ia-rag-chatbot/backend`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
# -N "" -C "deploy-symfony-ia-rag-chatbot" ; ajouter la clé PUBLIQUE (.pub) dans cPanel >
...
gh secret set DEPLOY_PROJECT_PATH -b"/home/{{user}}/repositories/symfony-ia-rag-chatbot/backend"
